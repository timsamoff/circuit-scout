# <img src="favicon/icon-192x192.png" width="32" height="32" alt="Circuit Scout"> Circuit Scout
...
- **Auto-export** - Automatically generates `circuits.json` for static hosting
